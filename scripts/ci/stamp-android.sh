...
# bundle-id.md), so the only per-landscape content is packaging: applicationId
...
echo "stamp-android: $LANDSCAPE ok — $NEW_ID versionCode=$VERSION_CODE label='$NEW_LABEL'"
